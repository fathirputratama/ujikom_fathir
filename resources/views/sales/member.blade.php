        ...
        <form action="{{ route('sales.store') }}" method="POST" class="max-w-6xl mt-6 mx-auto">
            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="w-full md:w-1/3 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
                    <h2 class="text-white text-xl font-bold mb-4">Informasi Member</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="member_name" class="text-white block text-sm font-medium">Nama Member</label>
                            <input type="text" id="member_name" name="member_name"
                                class="mt-1 block w-full rounded-xl border-gray-300 dark:bg-gray-700 dark:text-white"
                                value="{{ $member ? $member->name : old('member_name') }}"
                                {{ $member ? 'readonly' : '' }} />
                            @error('member_name')
                        ...
                        <div>
                            <label for="points" class="text-white block text-sm font-medium">Poin Saat Ini</label>
